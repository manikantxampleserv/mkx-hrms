...
/**
 * Seed corporate salary structures
 */
const seedSalaryStructures = async (): Promise<void> => {
  const salaryStructuresData = [
    {
      ...
      hra_percentage: 20.0,
      da_percentage: 10.0,
      special_allowance: 20.0,
      pf_percentage: 12.0,
      tax_deduction_type: "Standard",
      description: "Standard corporate workforce salary structure",
    },
    {
      name: "Executive Leadership",
      code: "EXEC-01",
      basic_percentage: 45.0,
      hra_percentage: 25.0,
      da_percentage: 10.0,
      special_allowance: 20.0,
      pf_percentage: 12.0,
      tax_deduction_type: "Standard",
      description: "Executive grade compensation package",
    },
  ];
  ...
  for (const item of salaryStructuresData) {
    await prisma.salaryStructure.upsert({
      ...
      update: {
        name: item.name,
        basic_percentage: item.basic_percentage,
        hra_percentage: item.hra_percentage,
        da_percentage: item.da_percentage,
        special_allowance: item.special_allowance,
        pf_percentage: item.pf_percentage,
        tax_deduction_type: item.tax_deduction_type,
        description: item.description,
      },
      create: {
        name: item.name,
